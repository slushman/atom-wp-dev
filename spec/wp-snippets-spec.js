...
import WpSnippets from '../lib/wp-snippets';
  ...
  describe('when the wp-snippets:toggle event is triggered', () => {
    it('hides and shows the modal panel', () => {
      ...
      runs(() => {
        ...
        let wpSnippetsElement = workspaceElement.querySelector('.wp-snippets');
        expect(wpSnippetsElement).toExist();

        let wpSnippetsPanel = atom.workspace.panelForItem(wpSnippetsElement);
